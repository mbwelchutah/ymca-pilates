    ...
    <div ref={containerRef} className="rounded-2xl overflow-hidden border border-divider bg-background">
      ...
      >
        <div className="flex items-center gap-2">
          <span className="text-[13px] font-medium text-text-secondary">Last registration run</span>
        ...
        <div className="border-t border-divider">
          ...
          {!loading && isBookingActive && isLatest && fetched && (!replay || replay.events.length === 0) && (
            <div className="px-4 py-4 flex items-center gap-2.5">
              ...
              <span className="text-[13px] text-accent-blue">Registration in progress — capturing events…</span>
            </div>
          )}
