...
export const api = {
  ...
  cancelRegistration: (id: number): Promise<{ success: boolean; action: string | null; message: string; staleState?: boolean; recheck?: { found: boolean | null; enrolled: boolean | null; reason: string } }> =>
