...
const REASON_LABELS: Record<string, string> = {
  ...
  'registration_unclear':        'Waitlist outcome ambiguous',
  'click_no_op_verified':        'No state change after waitlist click',
  'auth_redirect_during_action': 'Auth interrupted during waitlist flow',
